...
<body>
    ...
    <div class="gallery_area add_padding">
        <center><h2>Nos Exemples de Maisons Traditionnelles</h2></center><br><br><br><br>
        <div class="row">

            <div class="col-lg-4 col-md-6 ">
                <a href="img/change/tc1.jpg" class="img-pop-up">
                    <img src="img/change/tc1.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-4 col-md-6 ">
                <a href="img/change/tc4.jpg" class="img-pop-up">
                    <img src="img/change/tc4.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-4 col-md-6 ">
                <a href="img/change/tc13.jpg" class="img-pop-up">
                    <img src="img/change/tc13.jpg" class="img-fluid" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc44.jpg" class="img-pop-up">
                    <img src="img/change/tc44.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc45.jpg" class="img-pop-up">
                    <img src="img/change/tc45.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc46.jpg" class="img-pop-up">
                    <img src="img/change/tc46.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc33.jpg" class="img-pop-up">
                    <img src="img/change/tc33.jpg" class="img-fluid" alt="">
                </a>
            </div>
          </div>
        <br>
