            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>À Propos</h3>
                        <p><a href="index.php">Accueil</a> / À Propos</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="about_info">
                            ...
                            <a href="contact.php" class="boxed-btn3">Nous Contacter</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutters">
                  <div class="col-lg-4 col-md-4">
                      <div class="single_feature text-center">
                          ...
                          <p>Quel que soit votre projet, nous construisons votre bâtiment idéal, qui répond en tout points à vos attentes.</p>
                      </div>
                  </div>
                  <div class="col-lg-4 col-md-4">
                      <div class="single_feature text-center">
                  ...
                  <div class="col-lg-4 col-md-4">
                      <div class="single_feature text-center">
                          ...
                          <p>Dans tous les cas, soucieux du respect des délais nous menons une gestion rigoureuse de nos chantiers dans la Marnes.</p>
                      </div>
                  </div>
                </div>
            </div>
