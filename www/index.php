                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-9 col-md-9 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Un Projet ?</h3>
                                <p>TC Construction est à votre écoute !</p>
                                <a href="services.php" class="boxed-btn3">Voir Nos Prestations</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-9 col-md-9 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Une Volonté de construire ?</h3>
                                <p>TC Construction est à votre écoute !</p>
                                <a href="services.php" class="boxed-btn3">Voir Nos Prestations</a>
                            </div>
                        </div>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_3 overlay">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-9 col-md-9 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Agrandir Votre <br> Maison ?</h3>
                                <p>TC Construction est à votre écoute !</p>
                                <a href="services.php" class="boxed-btn3">Voir Nos Prestations</a>
                            </div>
                        </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-4 col-md-4">
                    <div class="single_feature text-center">
                        ...
                        <h3>SELON VOS ENVIES </h3>
                        <p>Quel que soit votre projet, nous construisons votre bâtiment idéal, qui répond en tous points à vos attentes.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single_feature text-center">
                        ...
                        <p>La maçonnerie, notre métier depuis plus de 25 ans. Entre écoute et conseils nous saurons vous proposer des solutions adaptées à vos besoins et exigences.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single_feature text-center">
                        ...
                        <h3>DES VALEURS HUMAINES</h3>
                        <p>Dans tous les cas, soucieux du respect des délais nous menons une gestion rigoureuse de nos chantiers dans la Marne.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="about_info">
                            <h3>Des Solutions Adaptées À Vos Besoins Et Exigences</h3>
                            <p class="first_para"> Parce que la maison idéale est avant tout celle qui correspond à vos envies, à votre mode de vie et à votre style en terme d'architecture, bref, une maison sur-mesure.</p>
                            <p>Vous savez ce que vous souhaitez, nous vous aidons à l'exprimer... Nous nous déplaçons dans toute la région afin de réaliser des devis personnalisés.</p>
                            <a href="about.php" class="boxed-btn3">À Propos de nous</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="gallery_nav">
                <div class="row align-items-center">
                    <div class="col-lg-12 col-md-12">
                        <h3 class="gallery_title text-center">Voir Nos Réalisations</h3>
                    </div>
                </div>
            </div>
        </div>
