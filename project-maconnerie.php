...
<body>
  ...
  <div class="bradcam_area bradcam_bg_2">
    ...
    <div class="gallery_area add_padding">
        <center><h2>Maçonnerie Générale </h2></center><br><br><br><br>
        <div class="row">

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc2.jpg" class="img-pop-up">
                    <img src="img/change/tc2.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc3.jpg" class="img-pop-up">
                    <img src="img/change/tc3.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc6.jpg" class="img-pop-up">
                    <img src="img/change/tc6.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc14.jpg" class="img-pop-up">
                    <img src="img/change/tc14.jpg" class="img-fluid" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc15.jpg" class="img-pop-up">
                    <img src="img/change/tc15.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc16.jpg" class="img-pop-up">
                    <img src="img/change/tc16.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc25.jpg" class="img-pop-up">
                    <img src="img/change/tc25.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc26.jpg" class="img-pop-up">
                    <img src="img/change/tc26.jpg" class="img-fluid" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 ">
                <a href="img/change/tc27.jpg" class="img-pop-up">
                    <img src="img/change/tc27.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-6 col-md-6 ">
                <a href="img/change/tc32.jpg" class="img-pop-up">
                    <img src="img/change/tc32.jpg" class="img-fluid" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc37.jpg" class="img-pop-up">
                    <img src="img/change/tc37.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc38.jpg" class="img-pop-up">
                    <img src="img/change/tc38.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc39.jpg" class="img-pop-up">
                    <img src="img/change/tc39.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc40.jpg" class="img-pop-up">
                    <img src="img/change/tc40.jpg" class="img-fluid" alt="">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc41.jpg" class="img-pop-up">
                    <img src="img/change/tc41.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc35.jpg" class="img-pop-up">
                    <img src="img/change/tc35.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc36.jpg" class="img-pop-up">
                    <img src="img/change/tc36.jpg" class="img-fluid" alt="">
                </a>
            </div>
