...
session_start();
  ...
  if(isset($_GET['editId']) && !empty($_GET['editId'])) {
    $editId = $_GET['editId'];
    $customer = $customerObj->displyaRecordByIdCat($editId);
  }

  if(isset($_POST['update'])) {
    $customerObj->updateRecordCat($_POST);
  }  
        ...
        <div class="col-md-5 mx-auto">
            <div class="formulaire-connexion mb-5">
                <div class="card-header bg-primary">
                    <h4 class="text-white">Editer Catégories</h4>
                </div>
                <div class="card-body bg-light">
                  <form action="editcategories.php" method="POST">
                    <div class="form-group">
                      <label for="titre">Nom catégorie:</label>
                      <input type="text" class="form-control" name="nomc" value="<?php echo $customer['nom_categorie']; ?>" required="">
                    </div>
                    <div class="form-group">
                      <input type="hidden" name="id_categorie" value="<?php echo $customer['id_categorie']; ?>">
