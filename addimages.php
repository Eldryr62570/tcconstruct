        ...
        <div class="col-md-5 mx-auto">
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h4 class="text-white">Ajouter des Images</h4>
                </div>
                <div class="card-body bg-light">
                <form action="db/uploadimage.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="prenom">Titre Image:</label>
                      <input type="text" class="form-control" name="titreimg" placeholder="Entrez votre titre" required="">
                    </div>

                        <div class="form-group">
                                    Selectionner l'image à Upload:
