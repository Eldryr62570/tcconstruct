  ...
  <div class="bradcam_area bradcam_bg_2">
    ...
    <!-- gallery_area-START -->
      <div class="gallery_area add_padding">
          <center><h2>Nos Exemples de Maisons Contemporaines</h2></center><br><br><br><br>
        <div class="row">

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc5.jpg" class="img-pop-up">
                    <img src="img/change/tc5.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc7.jpg" class="img-pop-up">
                    <img src="img/change/tc7.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc8.jpg" class="img-pop-up">
                    <img src="img/change/tc8.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc10.jpg" class="img-pop-up">
                    <img src="img/change/tc10.jpg" class="img-fluid" alt="">
                </a>
            </div>
          </div>
        <br>
        <div class="row">
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc11.jpg" class="img-pop-up">
                    <img src="img/change/tc11.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc12.jpg" class="img-pop-up">
                    <img src="img/change/tc12.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc18.jpg" class="img-pop-up">
                    <img src="img/change/tc18.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc19.jpg" class="img-pop-up">
                    <img src="img/change/tc19.jpg" class="img-fluid" alt="">
                </a>
            </div>
        </div><br>
  <div class="row">
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc20.jpg" class="img-pop-up">
                    <img src="img/change/tc20.jpg" class="img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc23.jpg" class="img-pop-up">
                    <img src="img/change/tc23.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc24.jpg" class="img-pop-up">
                    <img src="img/change/tc24.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc28.jpg" class="img-pop-up">
                    <img src="img/change/tc28.jpg" class="img-fluid" alt="">
                </a>
            </div>
          </div><br>
          <div class="row">
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc29.jpg" class="img-pop-up">
                    <img src="img/change/tc29.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc30.jpg" class="img-pop-up">
                    <img src="img/change/tc30.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc31.jpg" class="img-pop-up">
                    <img src="img/change/tc31.jpg" class="img-fluid" alt="">
                </a>
            </div>
          </div><br>
          <div class="row">
            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc42.jpg" class="img-pop-up">
                    <img src="img/change/tc42.jpg" class="img-fluid" alt="">
                </a>
            </div>

            <div class="col-lg-3 col-md-6 ">
                <a href="img/change/tc43.jpg" class="img-pop-up">
                    <img src="img/change/tc43.jpg" class="img-fluid" alt="">
                </a>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-50">
                        <h3>Voir plus de Réalisations</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="service_active owl-carousel">
                            <!--<div class="single_service">
                                ...
                                <div class="service_info">
                                    <a href="project-contemporaine.php">
                                        <center><h3>Nos Maisons Contemporaines </h3></center>
                                    </a>
                                    <center><a class="btn btn-dark" href="project-contemporaine.php" role="button"><font color="white">Cliquer ICI</font></a></center>
                                </div>
                            </div>-->
                            <div class="single_service">
                                <div class="thumb">
                                    <img src="img/screen02.jpg" alt="">
                                </div>
                                <div class="service_info">
                                    <a href="project-traditionnelles.php">
                                          <center><h3>Nos Maisons Traditionnelles </h3></center>
                                    </a>
                                    <center><a class="btn btn-dark" href="project-traditionnelles.php" role="button"><font color="white">Cliquer ICI</font></a></center>
                            ...
                            <div class="single_service">
                                ...
                                <div class="service_info">
                                    <a href="project-maconnerie.php">
                                        <center><h3>Nos Travaux de Maçonnerie </h3></center>
                                    </a>
                                    <center><a class="btn btn-dark" href="project-maconnerie.php" role="button"><font color="white">Cliquer ICI</font></a></center>
                             ...
                             <div class="single_service">
                                ...
                                <div class="service_info">
                                    <a href="project-renov.php">
                                          <center><h3>Nos Travaux de Rénovation </h3></center>
                                    </a>
                                    <center><a class="btn btn-dark" href="project-renov.php" role="button"><font color="white">Cliquer ICI</font></a></center>
