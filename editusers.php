        ...
        <div class="col-md-5 mx-auto">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="text-white">Update data Utilisateur</h4>
                </div>
                <div class="card-body bg-light">
                  <form action="editusers.php" method="POST">
                    <div class="form-group">
                      <label for="nom">Nom:</label>
                      <input type="text" class="form-control" name="nomu" value="<?php echo $customer['nom']; ?>" required="">
                    </div>
                    <div class="form-group">
                      <label for="age">Prénom:</label>
                      <input type="text" class="form-control" name="prenomu" value="<?php echo $customer['prenom']; ?>" required="">
                    </div>
                    <div class="form-group">
                      <label for="salary">Email:</label>
                      <input type="text" class="form-control" name="mailu" value="<?php echo $customer['mail']; ?>" required="">
                    </div>

                    <div class="form-group">
                      <label for="salary">Password:</label>
                      <input type="text" class="form-control" name="mdpu" value="<?php echo $customer['PASSWORD']; ?>" required="">
                    </div>

                    <div class="form-group">
                      <label for="salary">Rôle:</label>
                      <input type="text" class="form-control" name="mdpu" value="<?php echo $customer['id_role']; ?>" required="">
                    </div>

                    <div class="form-group">
                      <input type="hidden" name="idu" value="<?php echo $customer['id_users']; ?>">
