...
<head>
    ...
    <title>Tc-construct - Panel Admin</title>
</head>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="bradcam_text text-center">
                        <h3>Administration des Images</h3>
                        <p><a href="index.php">Admin</a> / Panel - Voir les Images de l'articles</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container mb80">
            ...
            <div class="boutonarticle1">
                        <button type="button" class="btn btn-secondary"><a href="panelarticle.php"><i class="fa fa-arrow-left"></i> Retour</a></button>
                    </div>
            <div class="presimg"><h4><i class="fa fa-image"></i>Photo Présentation</h4></div>
