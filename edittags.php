...
session_start();
  ...
  if(isset($_GET['editId']) && !empty($_GET['editId'])) {
    $editId = $_GET['editId'];
    $customer = $customerObj->displyaRecordByIdTags($editId);
  }

  if(isset($_POST['update'])) {
    $customerObj->updateRecordTags($_POST);
  }  
        ...
        <div class="col-md-5 mx-auto">
            <div class="formulaire-connexion mb-5">
                <div class="card-header bg-primary">
                    <h4 class="text-white">Editer Tag</h4>
                </div>
                <div class="card-body bg-light">
                  <form action="edit.php" method="POST">
                    <div class="form-group">
                      <label for="titre">Nom tag:</label>
                      <input type="text" class="form-control" name="nomt" value="<?php echo $customer['nom_tag']; ?>" required="">
                    </div>
                    <div class="form-group">
                      <input type="hidden" name="id_tag" value="<?php echo $customer['id_tag']; ?>">
